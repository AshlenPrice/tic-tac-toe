...
/***/ function(module, exports, __webpack_require__) {
	...
	// auth events
	var gameCliks = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = function Game() {
	  ...
	  this.gameOver = false;
	  this.gameApi = __webpack_require__(7);
	  this.possibleWins = [[0, 1, 2], [3, 4, 5], [6, 7, 8], // Row
	...
	Game.prototype.winner = function () {
	  if (this.board[0] === this.currentPlayer && this.board[1] === this.currentPlayer && this.board[2] === this.currentPlayer || this.board[3] === this.currentPlayer && this.board[4] === this.currentPlayer && this.board[5] === this.currentPlayer || this.board[6] === this.currentPlayer && this.board[7] === this.currentPlayer && this.board[8] === this.currentPlayer || this.board[0] === this.currentPlayer && this.board[3] === this.currentPlayer && this.board[6] === this.currentPlayer || this.board[1] === this.currentPlayer && this.board[4] === this.currentPlayer && this.board[7] === this.currentPlayer || this.board[2] === this.currentPlayer && this.board[5] === this.currentPlayer && this.board[8] === this.currentPlayer || this.board[0] === this.currentPlayer && this.board[4] === this.currentPlayer && this.board[8] === this.currentPlayer || this.board[2] === this.currentPlayer && this.board[4] === this.currentPlayer && this.board[6] === this.currentPlayer) {
	    //Not working - not sure why.
	    var pikaOrOsh = this.currentPlayer === "X" ? "Pikachu" : "Oshawott";
...
/***/ function(module, exports, __webpack_require__) {
	...
	$('.box').on('click', function () {
	  var move = $(this).attr('id'); // c3
	  var boardIndex = game.gameSpaces.indexOf(move); //3
	  var currentMove = game.currentPlayer;
	  var isValid = game.setMove(boardIndex);
	  if (isValid === true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var signUpFail = function signUpFail() {
	  $('#sign-up-prompt').text('Uh-Oh. Please Try Again!');
	};

	var signInFail = function signInFail() {
	  $('#sign-in-prompt').text('Uh-Oh! Please Try Again!');
	};
	...
	var changePwFail = function changePwFail(data) {
	  $('#change-pw-prompt').text('Uh-Oh! Please Try Again!');
	};

	var failure = function failure() {
	  $('#prompt').text('Theres seems to have been an error');
	};
